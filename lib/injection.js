 ...
 */
function renderHeadTemplate(presId, isPresenter, presenterKey, mobile) {
  var deferred = q.defer();
  ejs.renderFile(
    'templates/slideshare-head-patch.ejs', 
...
exports.injectSlidesharePatch = function(html, presId, isPresenter, presenterKey, mobile) {
  renderHeadTemplate(presId, isPresenter, presenterKey, mobile)
    .then(function(data) {
      debug('Injecting head patch into HTML source');
